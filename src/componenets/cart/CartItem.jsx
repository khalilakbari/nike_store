    ...
    <>
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            <div className=" grid items-center leading-none">
              <h1 className="font-medium text-lg text-slate-800 lg:text-xs">{title}</h1>
            ...
            <div className="flex items-center justify-around w-full">
              ...
              <div className="bg-theme-cart rounded text-white font-medium w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
                {cartQuantity}
              </div>
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button type="button" onClick={omRemoveItem}
