    ...
    <>
      <div
        ...
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center md:justify-items-center">
          ...
          <a href={url} className="flex items-center mb-3" target="_blank" role="button">
            <button type="button" className="button-theme bg-slate-900 shadow-slate-900 text-slate-100 py-1.5">
              {btn}
            </button>
          </a>
        </div>
        <div className="relative flex items-center justify-center max-w-xl lg:max-w-none w-full">
          <img 
            src={img} 
            alt={`img/${heading}`} 
