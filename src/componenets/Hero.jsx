  ...
  return (
    <>
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-contianer">
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            ...
            <div className="grid items-center gap-5 md:gap-3 absolute
             top-[33vh] lg:top-[27vh] left-[10%] xl:left-2 sm:left-1 w-auto h-auto">
              {videos?.map((val, i) => (
                <Clips 
                   key={i}
                   imgsrc={val.imgsrc}
            ...
            <div className="grid items-center absolute top-[33vh] lg:top-[27vh] right-3 sm:right-1 gap-3">
